    ...
    <div class="row justify-content-center">
        <div class="title col-12 col-lg-8">
            ...
            <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-5">
                Laporkan Benturan disini brooo
            </h3>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="media-container-column col-lg-8">
            ...
            {!! Form::open(['action' => 'FormBenturanController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'class'=> 'mbr-form']) !!}
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Lapor Benturan Kepentingan</h5>
