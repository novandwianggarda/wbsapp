<section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="{{asset('img/front/hero-bg.jpg')}}" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
    ...
    <ul class="home-social">
        ...
        <li>
            <a href="/lapor_gratifikasi"><i class="fa fa-gift" aria-hidden="true"></i><span>Lapor Gratifikasi</span></a>
        </li>
        <li>
            <a href="/lapor_benturan_kepentingan"><i class="fa fa-handshake-o" aria-hidden="true"></i><span>Lapor Benturan Kepentingan</span></a>
        </li>
    </ul>
    <!-- end home-social -->
